...
//alert(oneemp);
  $('.sddqinot').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oneemp+'"><img src="http://fourthforce.in/verifynew/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.ssd').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oneemp+'"><img src="http://fourthforce.in/verifynew/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneoooooooooooooooooooooooooo');
     $('.s1').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+one+'"><img src="http://fourthforce.in/verifynew/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
   $('.s1').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oneo+'"><img src="http://fourthforce.in/verifynew/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oneoo+'"><img src="http://fourthforce.in/verifynew/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oneooo+'"><img src="http://fourthforce.in/verifynew/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verifynew/uploads/'+oner+'"><img src="http://fourthforce.in/verifynew/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.ssd').append('<li><a href="http://fourthforce.in/verifynew/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verifynew/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if ( j == 0){
  ...
  //alert(one+'oneiiiiiiiiiiiiiiiiiiiiiiiiiii');
   $('.s1').append('<li><a href="http://fourthforce.in/verifynew/documents/addressid/'+one+'"><img src="http://fourthforce.in/verifynew/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
  $('.s1').append('<li><a href="http://fourthforce.in/verifynew/documents/addressid/'+oneo+'"><img src="http://fourthforce.in/verifynew/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verifynew/documents/addressid/'+oneoo+'"><img src="http://fourthforce.in/verifynew/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verifynew/documents/addressid/'+oneooo+'"><img src="http://fourthforce.in/verifynew/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verifynew/documents/addressid/'+oner+'"><img src="http://fourthforce.in/verifynew/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
$.ajax({url: "http://fourthforce.in/verifynew/slim/slim_four_ripsssjs/supervisor_status_to_inprogress.php?status_val="+status_val+"&verification_user_id="+verification_user_id+"&remark="+remark+"&qualification_id="+qualification_id+"&region_num="+region_num,
